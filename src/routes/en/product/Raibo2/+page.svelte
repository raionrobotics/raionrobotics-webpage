<svelte:head>
	...
	<meta name="Raibo2" content="Raibo2" />
</svelte:head>

<section id="hero" style="background-image: url('/images/Raibo2.JPG'); background-size: cover; width:100vw; aspect-ratio:4/3; padding-top:80px;">
	<div class="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-0 lg:pt-16 lg:grid-cols-12">
		<div class="mr-auto place-self-center lg:col-span-7">
			...
			<p class="indent-8 max-w-2xl mb-6 font-bold text-white lg:mb-8 md:text-lg lg:text-xl">
				Industrial quadruped robot platform
			</p>
		</div>
	</div>
</section>

<img src="/images/raibo2_specification.png" alt="Raibo 2 specifications" class="centered_image" />
